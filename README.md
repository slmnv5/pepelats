...
- Using attached screen or web page as looper monitor
- Three drum types synchronized to the looper
- Quantization - loop's length is adjusted to bar length or another loop length
