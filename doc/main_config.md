...
* menu_dir = 6x4 -- menu layout directory located in [6x4](./../config/menu/6x4) (6 buttons x 4 parts). There are other
  configurations switchable in service menu -- 4x2 and 4xN (N means any number)