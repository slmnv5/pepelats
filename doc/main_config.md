...
kbd_notes_linux = `, 4, 8, =, page up, -  -- 6 computer keys on linux keyboard if MIDI controller is missing  
kbd_notes_midi = 60, 62, 64, 65, 12, 13 -- 6 notes of MIDI foot controller pedal. Note velocity must be > 10  
