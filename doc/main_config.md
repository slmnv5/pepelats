...
* device_name = USB Audio -- name (or part of name) of the audio device to use, case-insensitive
* device_type = int16 -- data type to process and store audio information, int16 or float32
* drum_volume = 0.7 -- adjust all WAV drum samples volume by this factor
...
* menu_choice = 6x4 -- menu layout directory located in [6x4](./../config/menu/6x4) (6 buttons x 4 parts). New directories
