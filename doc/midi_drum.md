...
program, etc. Translation of these MIDI messages may be done with IOS app
...
*5) [0xF0, 0x5C, 0xF7] - sysEx sent when drum is randomized. Implent any change in slave device.
