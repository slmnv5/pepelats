...
*Euclid drum* rythms use four parameters: steps, beats, offset and accent (e.g. bd : 16, 4, 0, 0).
...
Euclid drum allows creating long non-repeating patterns using simple notation. As an example 208 step long sequence
